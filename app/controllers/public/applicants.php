...
class Applicants  extends Public_Controller {
	...
	public function pdf( $applicantId )
	{
		...
		$fileOptions['where'][] =      	"NOT `file_type` IN ('Whole Body Picture', 'Step Up Files', 'Step Up Files 1', 'Step Up Files 2', 'Step Up Files 3')";
		...
		$education = 
			...
			'<tr><tr >
                <th>Children(s):</th>
                <td>'.$applicants_raw[$applicant['applicant_id']]->applicant_children.' </td>
            </tr>';	
		...
		$workExperiences = 
			...
			$currency = $applicants_raw[$applicant['applicant_id']]->currency;	
			$mother = 
			'<tr><tr >
                <th>Mother Name:</th>
                <td>'.$applicants_raw[$applicant['applicant_id']]->applicant_mothers.' </td>
            </tr>';	
