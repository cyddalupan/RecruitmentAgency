                                            ...
                                            <div class="work-experience-start">
                                                ...
                                                <div class="row work-experience">
                                                    ...
                                                    <div class="col-sm-1">
                                                        <div class="form-group">
                                                            <label>Years</label>
                                                            <input type="text" name="applicant[work-experience-old][years][<?php echo $experience['experience_id']; ?>]" class="form-control work-years" placeholder="0" value="<?php echo $experience['experience_years']; ?>" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-1">
                                                        <a href="#" role="button" class="btn btn-danger btn-xs">Remove</a>
