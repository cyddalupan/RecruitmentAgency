                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select name="search[status]" class="form-control input-sm">
                                            ...
                                            <option value="0">Active File</option>
											 <option value="11">For Interview</option>
											<option value="15">Passporting</option>
											<option value="0">Available</option>
                                            <option value="3">Pre Selected</option>
                                            ...
                                            <option value="9">Deployed</option>
											 <option value="6">Not Qualified</option>
											  <option value="14">Blocklist</option>
