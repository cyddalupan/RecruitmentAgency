                ...
                <div class="row">
					   ...
					   <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select name="job[sstatus]" style="width:100%" >
								 <option value="" <?php echo ( isset( $post['job']['basic']['sstatus'] ) && $post['job']['basic']['sstatus'] == '' ) || $job['job_sstatus'] == '' ? 'selected' : ''; ?>>Active</option>
								 
								  <option value="Deacivate" <?php echo ( isset( $post['job']['basic']['sstatus'] ) && $post['job']['basic']['sstatus'] == 'Deacivate' ) || 
								  $job['job_sstatus'] == 'Deacivate' ? 'selected' : ''; ?>>Deacivate</option>
